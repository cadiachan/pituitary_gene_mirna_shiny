...
ui <- fluidPage(
  ...
  navbarPage("Mouse Pituitary Gland Data Hub",
             ...
             tabPanel("Home",icon = icon("home"),
                      ...
                      p("Male and female C57BL/6J mouse pituitary glands were collected from five postnatal ages spanning pubertal transition ",
                        "(postnatal days (PD) 12, 22, 27, 32, 37).",
                        "3'UTR-seq was performed on all five ages, whereas PD37 was not sequenced by small RNA-seq."),
                      p("These datasets accompany ",
                        a("our paper",
                          href = "https://bsd.biomedcentral.com/articles/10.1186/s13293-022-00467-7",
                          target = "_blank"),
                        "that explores mechanisms regulating the ",
                        "emergence of sex differences across puberty in the mouse pituitary."),
                      p("Raw data can be accessed at ",
                        ...
                        a("E-MTAB-9460.", 
                          ...
                          target = "_blank")),
                      p("Hypothalamic gene expression profiles generated from the same mice can be visualized ",
                        a("here",
                          href = "https://wilsonlab-sickkids-uoft.shinyapps.io/hypothalamus_gene_shiny",
                          target = "_blank"),
                        "."),
                      br(),
                      br(),
             ...
             tabPanel("About", icon=icon("quote-left"),
                      ...
                      tags$ol(
                        tags$li(p("Perry JR, Day F, Elks CE, Sulem, P, et al. Parent-of-origin-specific allelic associations among 106 genomic loci for age at menarche.",
                                   "Nature. 2014;514(7520):92-97. PMID: 25231870.",
                                   a("doi:10.1038/nature13545",
                                     href="https://pubmed.ncbi.nlm.nih.gov/25231870/",
                                     target = "_blank"))),
                        tags$li(p("Day FR, et al. Shared genetic aetiology of puberty timing between sexes and with",
                                   ...
                                   a("doi:10.1038/ncomms9842",
                                     ...
                                     target = "_blank"))),
                        tags$li(p("Day FR, et al. Genomic analyses identify hundreds of variants associated with age at menarche",
                                   ...
                                   a("doi:10.1038/ng.3841",
                                     ...
                                     target = "_blank"))),
                        tags$li(p("Hollis B, Day FR, et al. Genomic analysis of male puberty timing highlights shared genetic basis with hair colour",
                                   ...
                                   a("doi:10.1038/s41467-020-14451-5",
                                     ...
                                     target = "_blank"))),
                        tags$li(p("Ye Z, et al. Common variants at 10p12.31, 10q21.1 and 13q12.13 are associated with sporadic pituitary adenoma.",
                                   "Nat Genet. 2015;47(7):793-797. PMID: 26029870.",
                                   a("doi:10.1038/ng.3322",
                                     href="https://pubmed.ncbi.nlm.nih.gov/26029870/",
                                     target = "_blank"))),
                        tags$li(p("Fang Q, et al. Genetics of Combined Pituitary Hormone Deficiency: Roadmap into the Genome Era.",
                                   "Endocr Rev. 2016;37(6):636-675. PMID: 27828722.",
                                   a("doi:10.1210/er.2016-1101",
                                     href="https://pubmed.ncbi.nlm.nih.gov/27828722/",
                                     target = "_blank"))),
                        tags$li(p("Hauser BM, et al. The Epigenomics of Pituitary Adenoma.",
                                    ...
                                    a("doi:10.3389/fendo.2019.00290",
                                      ...
                                      target = "_blank"))),
                        tags$li(p("Kurtoglu S, et al. Neonatal Hypopituitarism: Approaches to Diagnosis and Treatment.",
                                   ...
                                   a("doi:10.4274/jcrpe.galenos.2018.2018.0036",
                                     ...
                                     target = "_blank"))),
                        tags$li(p("Isolated hypogonadotropic hypogonadism (IHH)/Kallmann syndrome.",
                      ...
                      br(),
                      h2("Funding"),
                      p("This work was supported by CIHR grants: 312557 (MRP/MDW/AG) and 437197 (Melissa Holmes/MDW/MRP).",
                      ...
                      br(),
                      h4("This application is maintained by C.Chan.")
             )
  )
)
